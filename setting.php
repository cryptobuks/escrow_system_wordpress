...
add_submenu_page( 'wallet_list', 'Wallet List', 'Wallet List',
    'administrator', 'wallet_list', array( $this, 'aistore_list_wallets_page' ));
		
	
add_submenu_page( 'wallet_list', 'Escrow List', 'Escrow List',
    'administrator', 'escrow_list', array( $this,'escrow_list'));
...
// wallet list
   ...
   public static function aistore_list_wallets_page() {
    ?>
